...
namespace PentaGE.Core.Entities
{
    ...
    /// </summary>
    public sealed class MeshEntity : Entity
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MeshEntity"/> class with the specified mesh, shader, texture, and material.
        /// </summary>
        ...
        public MeshEntity(Mesh mesh, Shader shader, Texture? texture = null, PBRMaterial? material = null)
        {
        ...
        public override object Clone()
        {
            ...
            var clone = (MeshEntity)base.Clone();
